...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/Update.ts");
/******/ })
/************************************************************************/
/******/ ({
...
function addUser() {
    ...
    var MyId = Number(LoggedInUserID);
    var URI = "https://birthawebservice20181031094923.azurewebsites.net/api/user/" + LoggedInUserID;
